...
public class MarkAssignmentCommandParserTest {
    ...
    public void parse_duplicateIndices_success() {
        ...
        try {
            MarkAssignmentCommand command = parser.parse(duplicateInput);
            ...
            assertEquals("mark", command.getCommandWord());
        } catch (ParseException pe) {
        ...
        try {
            MarkAssignmentCommand command = parser.parse(manyDuplicatesInput);
            assertEquals("mark", command.getCommandWord());
        } catch (ParseException pe) {
        ...
        try {
            MarkAssignmentCommand command = parser.parse(duplicateRangeInput);
            assertEquals("mark", command.getCommandWord());
        } catch (ParseException pe) {
